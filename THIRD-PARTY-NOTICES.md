...
| `adb.exe` (Android platform-tools) | Listar dispositivos, empujar ficheros, redirigir puertos, lanzar el servidor. **No se distribuye**: se usa el del SDK instalado en el equipo. | Apache 2.0 | Google / AOSP |
