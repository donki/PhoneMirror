...
public static class Loc
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["AssetsUpdated"] = "{0} bundled file(s) (adb, scrcpy-server) unpacked to {1}.",
        ...
        ["UnexpectedError"] = "Something went wrong, but the app is still open: {0}",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["AssetsUpdated"] = "{0} fichero(s) del paquete (adb, scrcpy-server) puestos en {1}.",
        ...
        ["UnexpectedError"] = "Algo ha fallado, pero la aplicación sigue abierta: {0}",
